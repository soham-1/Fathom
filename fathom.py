...
class signup(Frame):
    def __init__(self, master):
        ...
        Entry(self, textvariable=pass_entry,show='*', bg='pink').grid(row=3,column=3)
...
class profile(Frame):
    def __init__(self, master):
        ...
        Entry(self, textvariable=bio, bg='pink', width=40).grid(row=4, column=1, pady=7)
...
class homepage(Frame):
    ...
    def create_slide_show(self, img1, i=0):
        ...
        Label(self, text=f"{name[0]}", bg='lightblue', width=20).grid(row=3,column=5, padx=5, pady=5)
